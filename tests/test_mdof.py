...
def test_simulation_with_linearity():
    ...
    displacement1, _ = system.simulate(time, force=force1)
    displacement2, _ = system.simulate(time, force=force2)
    combined_displacement, _ = system.simulate(time, force=force1 + force2)
